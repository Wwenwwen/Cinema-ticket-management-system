...
<head>
    ...
    <title>用户中心-修改个人资料|XXXX电影票网_电影在线选座购票平台</title>
    ...
    <div class="container fn-clear">
        ...
        <div class="box-con userinfo-usercenter">
            ...
            <div class="box-info">
                <p class="fn-clear">
                    <span>账号：</span>
                    <span class="pr mobile">${bysj_account.mobile}</span>
                </p>
                <p class="fn-clear">
                    <span class="pt5">昵称：</span>
                    <span class="nick-name pr ipt"><input type="text" name="nickName" value="${bysj_account.nickname!""}" /></span>
                </p>
                <p class="fn-clear">
                    <span>性别：</span>
                    <span class="sex pr fn-clear">
                        <label><input type="radio" name="sex" value="1" <#if bysj_account.sex == 1>checked</#if> /><span>男</span></label>
                        <label><input type="radio" name="sex" value="2" <#if bysj_account.sex == 2>checked</#if> /><span>女</span></label>
                    </span>
                </p>
                <p class="fn-clear">
...
$(function () {
    var nickName = '${bysj_account.nickname!""}';
    var mobile = '${bysj_account.mobile!""}';
    var Sex = '${bysj_account.sex}';
    var submit = false;
