<div class="header">
    <div class="top-nav">
        <div class="container fn-clear">
              <span class="tip">
              	欢迎来到电影订票网
              	<#if bysj_account??>
              	<span class="user-name">${bysj_account.nickname!bysj_account.mobile}</span>
            ...
            <ul>
                <li><a href="/home/account/user-center" title="个人中心" data-flag="<#if bysj_account??>0<#else>1</#if>">个人中心</a></li>
                <li><a href="/home/account/user-order-list" title="我的订单" data-flag="<#if bysj_account??>0<#else>1</#if>">我的订单</a></li>
    ...
    <div class="main-nav">
        <div class="container fn-clear">
            <div class="logo"><a href="/home/index/index"><img src="/home/images/logo.png" alt="XXXX电影票" title="XXXX电影票" width="165"/></a></div>
            <div class="location" data-citycode="360100">
                <span class="lc"><#if bysj_area??>${bysj_area.name}<#else>请选择</#if></span>
                <ul class="other-city">
