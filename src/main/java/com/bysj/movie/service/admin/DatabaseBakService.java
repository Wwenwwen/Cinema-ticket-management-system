package com.bysj.movie.service.admin;
import java.io.File;
...
import com.bysj.movie.dao.admin.DatabaseBakDao;
import com.bysj.movie.entity.admin.DatabaseBak;
...
public class DatabaseBakService {
	...
	@Value("${bysj.database.backup.dir}")
	private String backUpDir;
	@Value("${bysj.database.backup.username}")
	private String dbUsername;
	@Value("${bysj.database.backup.password}")
	private String dbPwd;
	@Value("${bysj.database.backup.database.name}")
