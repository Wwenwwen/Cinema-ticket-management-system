package com.bysj.movie.entity.admin;
/**
 * 订单验证日志记录表
 */
...
import com.bysj.movie.annotion.ValidateEntity;
import com.bysj.movie.entity.common.BaseEntity;


@Entity
@Table(name="bysj_order_auth")
