...
public class IhuySmsUtil {
	...
	public static boolean sendSms(String mobile,String code){
		...
		NameValuePair[] data = {//提交短信
			    new NameValuePair("account", "C18572044"), //查看用户名 登录用户中心->验证码通知短信>产品总览->API接口信息->APIID
			    new NameValuePair("password", "0706a22c06554bff36321798c878fa5a"), //查看密码 登录用户中心->验证码通知短信>产品总览->API接口信息->APIKEY
	...
	public static void main(String[] args) {
		...
		IhuySmsUtil.sendSms("15622266642","0739");
	}
}
