...
<body style="background:url('/admin/images/bg.jpg') no-repeat; background-size: cover;">
    ...
    <div class="login-center">
      ...
      <form id="login-form" method="post">
        ...
        <div class="form-group">
          <button class="btn btn-block btn-success" type="button" id="submit-btn">立即登录</button>
        </div>
      </form>
      <hr>
      <footer class="col-sm-12 text-center">
        <p class="m-b-0">Copyright © 2022-2023All right reserved</p>
