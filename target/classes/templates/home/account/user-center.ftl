...
<head>
    ...
    <title>用户中心|XXXX电影票网_电影在线选座购票平台</title>
    ...
    <div class="container fn-clear">
        ...
        <div class="box-con index-usercenter">
            <div class="account-info">
                <ul class="fn-clear">
                    <li class="br photo">
                        <h4>${bysj_account.nickname!"暂无昵称"}</h4>
                        <p>${bysj_account.mobile}</p>
                        <span class="pic"><img src="/photo/view?filename=${bysj_account.headPic}" width="72" height="72" /></span>
                    </li>
                    <li class="br">
                        <h4>账户余额（点）</h4>
                        <p class="account">${bysj_account.balance}</p>
                    </li>
                    <li>
                        <h4>优惠券（张）</h4>
