...
<head>
    ...
    <title>XXXX电影票网_电影在线选座购票平台</title>
                ...
                <div class="schedule-filte">
                    ...
                    <div class="cinema">
                        <ul class="fn-clear">
                            ...
                            <#if bysj_area??>
                            <#if bysj_area.id == cinemaHallSession.cinema.area.cityId>
        ...
        <div class="comment-hot-detail pt30 fn-clear">
            <div class="comment">
                ...
                <div class="message-send">
                    ...
                    <span class="photo">
                    	<#if bysj_account??>
                    	<img id="userheader" src="/photo/view?filename=${bysj_account.headPic}" width="64" height="64" />
                    	<#else>
...
$(document).ready(function(){
    ...
    $("#recomment").focus(function () {
        if ("${bysj_account!"false"}".toLowerCase() == "false") {
