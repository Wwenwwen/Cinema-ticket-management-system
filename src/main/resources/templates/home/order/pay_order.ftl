...
<head>
    ...
    <title>确认支付订单-XXXX电影票网_电影在线选座购票平台</title>
                ...
                <ul>
                	<li class="wd">
                		<label class="account" style="width:370px;">
	                		...
	                		<span class="fn-left">余额支付(可用余额：<em class="red" id="user-balance">${bysj_account.balance}</em>元)</span>
                		</label>
                	</li>
                </ul>
            </div>
...
$(document).ready(function(){
    ...
    $("#btnpay").click(function(){
    	var balance = ${bysj_account.balance};
